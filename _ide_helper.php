...
namespace Cisco\Aliyunsms\Facades {
    ...
    class Aliyunsms
    {
        ...
        {
            /** @var \Cisco\Aliyunsms\Aliyunsms $instance */
            return $instance->test_rtn($msg);
        }
        ...
        {
            /** @var \Cisco\Aliyunsms\Aliyunsms $instance */
            return $instance->sendSms($phone, $signName, $templateCode, $templateParam);
        }
        ...
        {
            /** @var \Cisco\Aliyunsms\Aliyunsms $instance */
            return $instance->request($accessKeyId, $accessKeySecret, $domain, $params, $security);
        }
...
namespace {
    ...
    class Aliyunsms extends \Cisco\Aliyunsms\Facades\Aliyunsms
    {
    }
